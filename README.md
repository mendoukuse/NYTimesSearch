...
* [x] Add error handling for 429 Response
* [x] Use custom font for Text Views
* [x] Add various styling for the UI
* [x] Show snackbar when no results for query are found or if there are API Errors (Mainly added for debugging / sanity check)

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/mendoukuse/NYTimesSearch/blob/master/images/NYTimesSearch-Walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- I wanted to figure out how to add a loading spinner or intermediate screen while the data was being fetched but had a hard time figuring out how. 
